...
object test {
  val problem = new Pouring(Vector(4,9,19))       //> problem  : week7.Pouring = week7.Pouring@6393e80
  problem.moves                                   //> res0: scala.collection.immutable.IndexedSeq[Product with Serializable with we
                                                  ...
                                                  //| 
	problem.solution(17)                      //> res1: Stream[week7.test.problem.Path] = Stream(Fill(1) Fill(0) Pour(1,2) Pou
